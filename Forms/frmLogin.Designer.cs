namespace OOP_Final_Project_Team3
{
	partial class frmLogin
	{
		...
		private void InitializeComponent()
		{
			...
			// btnLogin
			// 
			btnLogin.Location = new Point(367, 234);
			...
			label1.Location = new Point(328, 102);
			label1.Name = "label1";
			...
			// txtUser
			// 
			txtUser.Location = new Point(403, 99);
			...
			// txtPass
			// 
			txtPass.Location = new Point(402, 131);
			...
			lblRegister.Location = new Point(367, 281);
